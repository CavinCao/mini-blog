...
Page({
  ...
  bindconfirm: async function (e) {
    let that = this;
    let value = e.detail.value || e.detail.value === '' ? e.detail.value : e.detail.searchContent;
    ...
    that.setData({
      ...
      nomore: false,
      nodata: false,
      whereItem: [value, 'createTime', '']
    })
    await this.getPostsList(value, 'createTime')
  },
